...
7. 客户端使用以下配置结构：
   ...
   ```json
   {
     ...
     "download_url": {
      "windows_x64": "https://update.dadaozixun.com/product-operation-report/releases/0.3.1/Product-Operation-Report-Windows-0.3.1-x64-Setup.exe",
      "mac_arm64": "https://update.dadaozixun.com/product-operation-report/releases/0.3.1/Product-Operation-Report-macOS-0.3.1-arm64.dmg",
      "mac_x64": "https://update.dadaozixun.com/product-operation-report/releases/0.3.1/Product-Operation-Report-macOS-0.3.1-x64.dmg"
     },
     "sha256": {
...
| Repository variable | `PRODUCT_OPERATION_REPORT_MIN_SUPPORTED_VERSION` | 可空；例如 `0.3.1` |
...
```powershell
npm run update:publish -- -Version 0.3.2 -MinSupportedVersion 0.3.1
```
